"""
RFMのF（Frequency）特徴量を強化したモデルのエントリーポイント
"""
import yaml
...
def main():
    ...
    print(f"Experiment: {exp_name} (RF enhanced)")
    ...
    # 特徴量生成（RFMのF特徴量強化版）
    print("[3/5] Creating features (RF enhanced)...")
    ...
    submission_path = submission_output_dir / f"sub_{exp_name}_rf.csv"
